...
function gameCommands(){
	...
	alert("You've rolled " + results3);
	let weapon = aWeapon(results3);
	let results4 = rollDice(10);
	console.log(results4);
	alert("You've rolled " + results4);
